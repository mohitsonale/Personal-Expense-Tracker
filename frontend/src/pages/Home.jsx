      ...
      >
        ...
        <div className="w-32 h-32 mb-10 flex items-center justify-center">
          <img
            src={logo1}
            alt="logo"
            className="w-full h-full cursor-pointer hover:shadow-blue-300 shadow-md 
            hover:scale-105 hover:rotate-180 transition-all duration-700 object-cover rounded-full"
          />
        </div>
